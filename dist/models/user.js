...
module.exports = function (sequelize, DataTypes) {
  ...
  User.init({
    ...
    hooks: {
      ...
      afterUpdate: function afterUpdate(user) {
        console.log('After updating User:', user.name);
      },
      beforeDestroy: function beforeDestroy(user) {
        console.log('Before deleting User:', user.name);
      },
      afterDestroy: function afterDestroy(user) {
        console.log('After deleting User:', user.name);
      },
      beforeBulkCreate: function beforeBulkCreate(user) {
        console.log('After bulk creating User:', user.name);
      },
      beforeBulkUpdate: function beforeBulkUpdate(user) {
        console.log('After bulk updating User:', user.name);
      },
      beforeBulkDestroy: function beforeBulkDestroy(user) {
