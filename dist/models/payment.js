...
module.exports = function (sequelize, DataTypes) {
  ...
  Payment.init({
    ...
    underscored: true,
    hooks: {
      beforeCreate: function beforeCreate(payment) {
        console.log('Before creating Payment:', payment.id);
      },
      afterCreate: function afterCreate(payment) {
        console.log('After creating Payment:', payment.id);
      },
      beforeUpdate: function beforeUpdate(payment) {
        console.log('Before updating Payment:', payment.id);
      },
      afterUpdate: function afterUpdate(payment) {
        console.log('After updating Payment:', payment.id);
      },
      beforeDestroy: function beforeDestroy(payment) {
        console.log('Before deleting Payment:', payment.id);
      },
      afterDestroy: function afterDestroy(payment) {
